...
CREATE TABLE `favorite` (
  ...
  CONSTRAINT `tutorial_idtutorial_fk` FOREIGN KEY (`tutorial_idtutorial`) REFERENCES `tutorial` (`idtutorial`),
  CONSTRAINT `user_iduser_fk` FOREIGN KEY (`user_iduser`) REFERENCES `user` (`iduser`)
...
-- Dump completed on 2021-11-18  0:17:01
